...
<h1 class="bg-muted">Laboriosam consectetur ea.</h1>
<h1 class="bg-success">Voluptate natus qui.</h1>
<h1 class="bg-info">Animi velit natus!</h1>
<h1 class="bg-warning">Aliquam facere est.</h1>
<h1 class="bg-danger text-white">Unde dignissimos soluta!</h1>
<h1 class="bg-secondary">Illum facere voluptate!</h1>
<h1 class="bg-white">Dolorum libero recusandae!</h1>
<h1 class="bg-dark">Lorem ipsum dolor.</h1>
<h1 class="bg-body">Lorem ipsum dolor.</h1>
</div>
</body>
</html>